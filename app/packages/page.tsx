...
export default function PackagesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 h-full flex items-center justify-center relative z-10">
          <motion.div {...fadeInUp} className="text-center">
            ...
            <div className="flex items-center justify-center space-x-2 text-gray-700 dark:text-gray-300">
              <Link href="/" className="hover:text-amber-800 transition-colors dark:hover:text-amber-500">
                Home
              </Link>
              <span>•</span>
              <span className="text-red-500 font-semibold dark:text-red-400">Package's</span>
            </div>
          </motion.div>
        </div>
      </motion.section>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      <div className="text-center p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border dark:from-gray-900 dark:to-gray-800 dark:border-gray-700">
                        <div className="text-sm text-gray-600 mb-1 dark:text-gray-400">৳</div>
                        <div className="text-3xl font-bold text-red-500 dark:text-red-400">{pkg.price60}</div>
                      ...
                      <div className="text-center p-4 bg-gradient-to-br from-amber-50 to-orange-100 rounded-xl border border-amber-200 dark:from-gray-900 dark:to-gray-800 dark:border-gray-700">
                        <div className="text-sm text-gray-600 mb-1 dark:text-gray-400">৳</div>
                        <div className="text-3xl font-bold text-amber-600 dark:text-amber-500">{pkg.price90}</div>
                        <div className="text-sm text-gray-600 dark:text-gray-400">90 Min</div>
                      </div>
                    </div>

                    {/* Description */}
                    <p className="text-gray-600 leading-relaxed mb-8 text-sm dark:text-gray-400">{pkg.description}</p>
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <motion.div {...fadeInUp} className="space-y-6">
            <h2 className="text-4xl font-bold dark:text-gray-100">Ready to Experience Bliss?</h2>
            <p className="text-xl opacity-90 max-w-2xl mx-auto dark:text-gray-300">
              Choose your perfect package and let us take care of your wellness journey. Book now for an unforgettable
              spa experience.
            </p>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-16 dark:bg-gradient-to-r dark:from-gray-900 dark:to-gray-900">
        <div className="container mx-auto px-4">
