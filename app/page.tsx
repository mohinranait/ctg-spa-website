...
import { Phone, MapPin, Clock, Star, ChevronDown, Globe } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-6">
              <Link
                href="/"
                className="text-amber-800 dark:text-amber-400 font-semibold border-b-2 border-amber-800 dark:border-amber-400 transition-colors"
              >
                Home
              </Link>
              <Link
          ...
          >
            ...
            >
              <Link
                href="/"
                className="text-amber-800 dark:text-amber-400 font-semibold px-4 py-2 transition-colors"
        ...
        <div className="container mx-auto px-4 h-full flex items-center">
          <div className="grid md:grid-cols-2 gap-8 items-center w-full">
            <motion.div {...fadeInUp} className="space-y-6">
              <h1 className="text-5xl font-bold text-amber-900 dark:text-amber-400 transition-colors">BLISS SPA</h1>
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div {...fadeInUp}>
            ...
            <div className="max-w-4xl mx-auto text-gray-600 dark:text-gray-400 leading-relaxed space-y-4 transition-colors">
              <p>
                Welcome to Bliss Spa, your premier destination for relaxation and rejuvenation in Dhaka. We offer a
                comprehensive range of spa and massage services designed to help you unwind, refresh, and restore your
                body and mind.
              </p>
              <p>
                Our experienced therapists use only the finest natural products and time-tested techniques to ensure you
                receive the highest quality treatment. From traditional massages to modern spa therapies, we have
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="text-center p-8 hover:shadow-lg transition-shadow bg-white dark:bg-gray-900 border dark:border-gray-700">
                  <CardContent className="space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 transition-colors">{item.subtitle}</p>
                    <p className="text-amber-800 dark:text-amber-400 font-medium transition-colors">{item.content}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp} className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
                Experience ultimate relaxation with our premium spa and massage services. Our skilled therapists provide
                personalized treatments in a serene environment designed to rejuvenate your body and soul.
              </p>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed transition-colors">
                Discover our signature collection of therapeutic treatments that combine traditional techniques with
                modern wellness practices. Each session is tailored to your specific needs and preferences.
              </p>
      ...
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-4 transition-colors">Our Packages</h2>
          </div>
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className="text-center p-6 hover:shadow-lg transition-shadow border-2 hover:border-amber-200 dark:hover:border-amber-600 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                  <CardContent className="space-y-4">
                    ...
                    <div className="text-gray-600 dark:text-gray-400 transition-colors">{pkg.duration}</div>
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div {...fadeInUp} className="space-y-6">
            <h2 className="text-4xl font-bold">Affordable and Reliable Spa Service.</h2>
          ...
          <motion.div {...fadeInUp}>
            ...
            <div className="bg-amber-800 dark:bg-amber-900 text-white p-8 rounded-lg max-w-2xl mx-auto transition-colors">
              ...
              <p className="text-lg italic mb-4">
                "Amazing experience at Bliss Spa! The staff is professional and the treatments are top-notch. I feel
                completely relaxed and rejuvenated after every visit."
              </p>
      ...
      <footer className="bg-gray-800 dark:bg-gray-950 text-white py-12 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-amber-400">BLISS SPA</h3>
              <p className="text-gray-300 dark:text-gray-400 transition-colors">
                Your premier destination for relaxation and wellness in Dhaka.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300 dark:text-gray-400 transition-colors">
                <p>+8801738 001065</p>
                <p>www.blissspadh.com</p>
                <p>Dhaka, Bangladesh</p>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-700 dark:border-gray-600 mt-8 pt-8 text-center text-gray-300 dark:text-gray-400 transition-colors">
            <p>&copy; 2024 Bliss Spa. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
