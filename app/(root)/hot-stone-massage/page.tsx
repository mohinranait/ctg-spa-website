      ...
      <main className="py-8">
        <div className="container mx-auto max-w-5xl px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h1 className="text-4xl lg:text-5xl font-bold text-gray-800 dark:text-gray-200 leading-tight">
                  Best Hot Stone Massage in Chittagong
                </h1>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                  How is a Hot Stone Massage Performed in a Spa? A hot stone
                  massage in a spa is a carefully orchestrated experience
                  designed for maximum relaxation and therapeutic benefit:
                  Preparation: The session begins in a serene, private treatment
                  room. The therapist will usually conduct a brief consultation
                  to understand your health history, any areas of tension, and
                  your preferences for heat and pressure.
                </p>
              </div>
          ...
          <motion.section
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
              Benefits of a Hot Stone Massage The combination of heat and
              massage in a hot stone treatment offers numerous physical and
              mental benefits: Deep Muscle Relaxation: The penetrating heat from
              the stones helps to relax tight muscles more effectively than
              manual massage alone, alleviating tension and stiffness. Pain
              Relief: It can significantly reduce muscle pain, soreness, and
              chronic aches, including those associated with conditions like
              fibromyalgia, arthritis, and sciatica, by increasing blood flow
